...
public class OrderController:Controller
{
    ...
    private Payment ProcessPayment()
    {
        ...
        options.ApiKey = "sandbox-pXQG9RPtDhepbwRq7p17emZeemxLmLmB";
        options.SecretKey = "sandbox-jGj7K5MlHyOHXfHQeverXsGOy3L6UP16";
        ...
        paymentCard.CardHolderName = "Yusuf Talha ERDOGMUS";
        ...
        buyer.Id = "BY789";
        buyer.Name = "Yusuf Talha";
        buyer.Surname = "ERDOGMUS";
        ...
        shippingAddress.ContactName = "Yusuf Talha Erdogmus";
